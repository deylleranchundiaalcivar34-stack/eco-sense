  ...
  return (
    ...
    >
      <div className="container max-w-4xl mx-auto text-center z-10">
        <div className="space-y-6">
          ...
          <div className="flex justify-center space-x-4 mt-6 opacity-0 animate-fade-in-delay-4">
            <a
              href="#about"
              className="px-6 py-3 bg-primary text-primary-foreground rounded-full hover:bg-primary/80 transition-colors"
            >
              Más información
            </a>
          </div>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex flex-col items-center animate-bounce">
        <span className="text-sm text-muted-foreground mb-2">Desplazarse hacia abajo</span>
